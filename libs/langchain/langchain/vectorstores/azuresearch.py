...
def _get_search_client(
    ...
    from azure.search.documents.indexes.models import (
        HnswAlgorithmConfiguration, # HnswVectorSearchAlgorithmConfiguration was used in versions of azure-search-documents < 11.4.0
        PrioritizedFields,
        SearchIndex,
            ...
            vector_search = VectorSearch(
                algorithm_configurations=[
                    HnswAlgorithmConfiguration( 
                        # previously HnswVectorSearchAlgorithmConfiguration
                        name="default",
                        kind="hnsw",
